...
namespace MVAPINASAJR.ViewModels
{
    public class ApodViewModelJR : INotifyPropertyChanged
    {
        ...
        private ApodServiceJR service;
        public ApodServiceJR Service
        {
            get
            {
                if (service == null)
                {
                    service = new ApodServiceJR();
                }
                return service;
            }
        }
        ...
        {
            ApodJR dto = await Service.GetImage(day);
            if (dto == null)
            {
